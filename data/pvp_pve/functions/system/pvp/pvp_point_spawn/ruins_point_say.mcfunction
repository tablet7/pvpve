...
#なかだ
execute if score Timer random_rand matches 3 run say 20秒後に「闘技場」にポイントが出現します
...
#地下
execute if score Timer random_rand matches 4 run say 20秒後に「地下」にポイントが出現します
...
#塔
execute if score Timer random_rand matches 5 run say 20秒後に「塔」にポイントが出現します
...
#アスレチック
execute if score Timer random_rand matches 6 run say 20秒後に「アスレチック」にポイントが出現します
...
#図書館
execute if score Timer random_rand matches 7 run say 20秒後に「図書館」にポイントが出現します
...
#ピラミッド
execute if score Timer random_rand matches 8 run say 20秒後に「ピラミッド」にポイントが出現します
