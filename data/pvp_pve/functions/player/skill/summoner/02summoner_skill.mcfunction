...
$summon villager ~ ~ ~ {Silent:1b,DeathLootTable:"pvp_pve:item/summoner/skill2_team_item/$(team_set)_item",Team:"$(Team)",NoAI:1b,Tags:["skill_e","sum_skill","summoner_skill2"],active_effects:[{id:"minecraft:invisibility",amplifier:1b,duration:2000}]}
