...
execute as @e[tag=restraint_trap] at @s run scoreboard players set @s trap_cnt 1200
...
execute as @e[tag=fire_trap] at @s run scoreboard players set @s trap_cnt 1200
