#> pvp_pve:player/skill/shadow/skill_check/01skill_check
...
#recast=0なら発動
execute if score @s skill1_recast matches 0 run function pvp_pve:player/skill/shadow/01shadow_skill
