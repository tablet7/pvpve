...
execute if score @s team_set matches 4 run execute as @e[tag=shadow_shadow,distance=..20,scores={team_set=4}] at @s run execute as @e[team=Enemy,tag=!skill_e,distance=..4] run damage @s 12
execute if score @s team_set matches 5 run execute as @e[tag=shadow_shadow,distance=..20,scores={team_set=5}] at @s run execute as @e[team=Enemy,tag=!skill_e,distance=..4] run damage @s 12
execute if score @s team_set matches 6 run execute as @e[tag=shadow_shadow,distance=..20,scores={team_set=6}] at @s run execute as @e[team=Enemy,tag=!skill_e,distance=..4] run damage @s 12
