...
$execute as @e[distance=..15,team=!$(Team)] at @s run scoreboard players set @e[limit=1,sort=nearest,team=$(Team),type=armor_stand,tag=malchut_skill4] summoner_skill_cnt 100
