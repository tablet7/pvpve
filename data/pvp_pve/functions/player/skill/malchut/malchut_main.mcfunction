...
#skill3
execute as @e[tag=malchut_skill2] at @s run tp @s ^ ^ ^1.5
execute as @e[tag=malchut_skill2] at @s run execute positioned ^ ^1.7 ^ run particle dust 1 1 0 5

execute as @e[tag=malchut_skill2,team=Red] at @s run function pvp_pve:player/skill/malchut/mc03_skill {Team:Red}
execute as @e[tag=malchut_skill2,team=Blue] at @s run function pvp_pve:player/skill/malchut/mc03_skill {Team:Blue}
execute as @e[tag=malchut_skill2,team=Yellow] at @s run function pvp_pve:player/skill/malchut/mc03_skill {Team:Yellow}
execute as @e[tag=malchut_skill2,team=Green] at @s run function pvp_pve:player/skill/malchut/mc03_skill {Team:Green}
execute as @e[tag=malchut_skill2,team=Gray] at @s run function pvp_pve:player/skill/malchut/mc03_skill {Team:Gray}
execute as @e[tag=malchut_skill2,team=Black] at @s run function pvp_pve:player/skill/malchut/mc03_skill {Team:Black}
