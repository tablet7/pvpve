...
$execute as @e[team=$(Team),tag=filip_skill2_2,limit=1,sort=nearest] at @s rotated as @p run tp @s ~ ~ ~ ~ ~
$execute as @e[team=$(Team),tag=filip_skill2_2,limit=1,sort=nearest] at @s run scoreboard players add @s filip_skill2_2 21

execute as @a[distance=..10] at @s run playsound entity.blaze.shoot master @s ~ ~ ~