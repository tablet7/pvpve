...
$execute as @e[team=!$(Team),distance=..3.5] at @s run damage @s 6

$execute as @e[team=!$(Team),distance=..3.5] at @s run function pvp_pve:player/skill/filip_fire/filip_fire_fire2
