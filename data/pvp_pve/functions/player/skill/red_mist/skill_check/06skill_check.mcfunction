#> pvp_pve:player/skill/red_mist/skill_check/06skill_check
...
#recast=0なら発動
execute if score @s skill6_recast matches 0 run function pvp_pve:player/skill/red_mist/06red_mist_skill
