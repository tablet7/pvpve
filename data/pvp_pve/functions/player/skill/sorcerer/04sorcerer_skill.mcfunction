...
$execute as @e[distance=..12,team=!$(Team)] at @s run function pvp_pve:player/skill/sorcerer/mc_04skill {Team:$(Team)}

$function pvp_pve:player/skill/sorcerer/mc_04skill {Team:$(Team)}
