...
kill @e[tag=eg_legendary2,distance=..25]

execute if score @s random_rand matches 1 run function pvp_pve:enemy/coordinate/legendary_c/legendary1
execute if score @s random_rand matches 2 run function pvp_pve:enemy/coordinate/common_c/test
execute if score @s random_rand matches 3 run function pvp_pve:enemy/coordinate/rare_c/rare1
execute if score @s random_rand matches 4 run function pvp_pve:enemy/coordinate/rare_c/rare2
execute if score @s random_rand matches 5 run function pvp_pve:enemy/coordinate/legendary_c/legendary2
