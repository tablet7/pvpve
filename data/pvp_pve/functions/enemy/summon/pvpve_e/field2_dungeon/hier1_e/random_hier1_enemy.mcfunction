...
execute store result score @s random_rand run random value 1..15
execute store result score @s random_rand run random value 1..15
...
$execute if score @s random_rand matches 7..8 run function pvp_pve:enemy/summon/pvpve_e/field2_dungeon/hier1_e/zombie {x:$(x),y:$(y),z:$(z)}
...
$execute if score @s random_rand matches 15 run function pvp_pve:enemy/summon/pvpve_e/field2_dungeon/hier1_e/mimic_r {x:$(x),y:$(y),z:$(z)} 
